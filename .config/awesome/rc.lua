...
battindicator = awful.widget.watch("bash -c '~/./.config/awesome/power_indicator.bash'",0.1)
...
--    }
    ...
    elseif s.index == 2 then
       s.mywibox = awful.wibar({ position = "top", screen = s, bg = theme_lua.bar2.bg_normal, fg = theme_lua.bar2.fg_normal })
    end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "u", awful.client.urgent.jumpto,
              ...
              awful.key({ modkey, "Shift" }, "l", function () client.focus:move_to_screen(screen.count()) end,
                {description = "move to right monitor", group = "client"}),
    awful.key({ modkey, "Shift" }, "h", function () client.focus:move_to_screen(screen.count() - 1) end,
    ...
    awful.key({ modkey, "Control" }, "n",
        ...
        awful.key({ modkey, "Shift" }, "n", function () awful.spawn("nautilus") end,
            { description = "open nautilus", group = "apps" }),
